...
This course uses a third-party app, Qwiklabs Assessment: Introduction to Git, to enhance your learning experience. The app will reference basic information like your name, email, and Coursera ID.
